...
var subMenu = document.getElementById('dropdown-trigger');
var subMenu2 = document.getElementById('dropdown-trigger-2');
var modalTrigger = document.querySelectorAll('.modalTrigger');
var modal = document.getElementById('modal');
var year = document.getElementById('year');
var back = document.getElementById('back'); // set year in copyright

year.textContent = new Date().getFullYear(); // Open Nav from Hamburger
...
modalTrigger.forEach(function (el) {
  return el.addEventListener('click', toggleModal);
}); // Close modal
...
var mdBreakpoint = window.matchMedia("(min-width: 768px)"); // if (mdBreakpoint.matches) {
