...
var xlBreakpoint = window.matchMedia("(min-width: 1300px)"); // Horizontal scroll on books section

if (lgBreakpoint.matches) {
  scrollWrap.style.height = "".concat(calcDynamicHeight(scrollStage), "px");
} else {
...
window.addEventListener('scroll', function () {
  ...
  if (lgBreakpoint.matches) {
    ...
    scrollStage.style.transform = "translateX(-".concat(sticky.offsetTop, "px)");
  } else {
